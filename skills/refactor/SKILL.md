...
```
1. RED    - If adding behavior, write failing test first
2. GREEN  - Make minimal changes to pass tests
3. REFACTOR - Apply pattern while keeping tests green
